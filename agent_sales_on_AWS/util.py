...
Este script foi desenvolvido por "Felix Yu".
"""
import boto3
import textwrap

region_name = 'us-east-1' # Faça uma verificação para garantir que esta é a mesma região onde você criou seu agente
